...
export default function Favorites() {
  ...
  if (error) return <div className="text-center mt-20 text-destructive font-bold">Failed to load Favorites</div>;
    ...
    <div className="min-h-screen bg-background bg-pokeball-pattern pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground font-medium">Your personally curated dream team.</p>
        </div>
        ...
        {!favorites || favorites.length === 0 ? (
          <div className="text-center py-32 bg-card rounded-3xl border border-border shadow-sm">
            ...
            <h3 className="text-2xl font-display font-bold text-foreground mb-3">No favorites yet</h3>
